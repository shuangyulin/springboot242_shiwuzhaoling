        ...
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='shiwuzhaoling'">
                    <el-form-item class="input" v-if="type!='info'"  label="物品状态" prop="statusValue">
                        <el-input v-model="shiwuzhaolingForm.statusValue"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    ...
                    <div v-else>
                        <el-form-item class="input" label="审核" prop="yesnoValue">
                        <el-input v-model="ruleForm.yesnoValue"
                            placeholder="审核" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="详情" prop="shiwurenlingText">
                        <el-input type="textarea"  :readonly="ro.shiwurenlingText" v-model="ruleForm.shiwurenlingText" placeholder="详情"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.shiwurenlingText" label="详情" prop="shiwurenlingText">
            ...
            <el-form-item class="btn">
                ...
                <el-button v-if="type!='info'" class="btn-close" @click="quxiao()">取消</el-button>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yesnoTypesOptions = data.data.list;
                    }
                });
        ...
        mounted() {
			...
			if(this.$route.query.id != null){
				this.shiwuzhaolingChange(this.$route.query.id)
				this.ruleForm.shiwuzhaolingId = this.$route.query.id
			}
        },
        methods: {
            // 下载
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='shiwuzhaolingId'){
                          this.ruleForm.shiwuzhaolingId = obj[o];
                          this.ro.shiwuzhaolingId = true;
                          continue;
                      }
                      if(o=='yonghuId'){
                      ...
                      if(o=='yesnoTypes'){
                          this.ruleForm.yesnoTypes = obj[o];
                          this.ro.yesnoTypes = true;
                          continue;
                      }
                      if(o=='shiwurenlingText'){
                          this.ruleForm.shiwurenlingText = obj[o];
                          this.ro.shiwurenlingText = true;
                          continue;
                      }
                      if(o=='insertTime'){
            ...
            info(id) {
                this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        this.shiwuzhaolingChange(data.data.shiwuzhaolingId)
