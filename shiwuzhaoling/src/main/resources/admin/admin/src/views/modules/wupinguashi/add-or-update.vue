            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='wupinguashiName'){
                          this.ruleForm.wupinguashiName = obj[o];
                          this.ro.wupinguashiName = true;
                          continue;
                      }
                      ...
                      if(o=='wupinguashiPhoto'){
                          this.ruleForm.wupinguashiPhoto = obj[o];
                          this.ro.wupinguashiPhoto = true;
                          continue;
                      }
                      if(o=='wupinguashiTime'){
                          this.ruleForm.wupinguashiTime = obj[o];
                          this.ro.wupinguashiTime = true;
                          continue;
                      }
                      if(o=='yonghuId'){
                      ...
                      if(o=='wupinguashiDizhi'){
                          this.ruleForm.wupinguashiDizhi = obj[o];
                          this.ro.wupinguashiDizhi = true;
                          continue;
                      }
                      if(o=='wupinguashiContent'){
                          this.ruleForm.wupinguashiContent = obj[o];
                          this.ro.wupinguashiContent = true;
                          continue;
                      }
                    }
                }
